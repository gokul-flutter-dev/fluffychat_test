...
import 'package:fluffychat/glug_chat/utils/init_with_restore.dart';
...
import 'package:fluffychat/glug_chat/utils/uia_request_manager.dart';
import 'package:fluffychat/glug_chat/utils/voip_plugin.dart';
    ...
    final candidate =
      ...
      store,
          ...
          ..onLoginStateChanged
            ...
            FluffyChatApp.router.go('/glugHome');
          });
    ...
    onLoginStateChanged[name] ??= c.onLoginStateChanged.stream.listen((state) {
      ...
      if (loggedInWithMultipleClients && state != LoginState.loggedIn) {
        ...
        FluffyChatApp.router
            .go(state == LoginState.loggedIn ? '/glugHome' : '/home');
      }
    });
